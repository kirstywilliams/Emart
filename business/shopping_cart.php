<?php
	...
	class ShoppingCart
	{
		...
		public static function AddProduct($itemId, $attributes)
		{
			// Build SQL query
		...
		{
			// Build SQL query
			$sql = 'CALL shopping_cart_update(:product_id, :quantity)';
		...
		{
			// Build SQL query
			$sql = 'CALL shopping_cart_remove_product(:product_id)';
		...
		{
			// Build SQL query
			$sql = 'CALL shopping_cart_save_product_for_later(:product_id)';
		...
		{
			// Build SQL query
			$sql = 'CALL shopping_cart_move_product_to_cart(:product_id)';
		...
		// Create a new order
		public static function CreateOrder($customerId, $shippingId)
		{
			// Build SQL query
			$sql = 'CALL shopping_cart_create_order(:cart_id, :customer_id, :shipping_id)';
			
			// Build the parameters array
			$params = array (':cart_id' => self::GetCartId(),
			':customer_id' => $customerId, ':shipping_id' => $shippingId);
