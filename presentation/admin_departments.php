...
class AdminDepartments
{
	...
	public function init()
	{
		...
		if ($this->_mAction == 'add_dept')
		{
			...
			$this->mErrorMessage = 'Department telephone number required';
			if ($department_description == null)
			$this->mErrorMessage = 'Department description required';
			if ($this->mErrorMessage == null)
			{
				Catalog::AddDepartment($department_name, $department_manager, $department_number, $department_description);
		...
		if ($this->_mAction == 'update_dept')
		{
			...
			$department_manager = $_POST['manager'];
			$department_number = $_POST['number'];
			...
			if ($this->mErrorMessage == null)
			{
				...
				$department_name, $department_manager, $department_number, $department_description);
				header('Location: ' . $this->mLinkToDepartmentsAdmin);
			}
		}
