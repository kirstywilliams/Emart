...
class StoreAdmin
{
	...
	public function init()
	{
		...
		else
		{
			...
			elseif ($admin_page == 'Customers')
				$this->mContentsCell = 'admin_customers.tpl';
			elseif ($admin_page == 'CustomerDetails')
				$this->mContentsCell = 'admin_customer_details.tpl';
			elseif ($admin_page == 'Suppliers')
				$this->mContentsCell = 'admin_suppliers.tpl';
			elseif ($admin_page == 'SupplierDetails')
				$this->mContentsCell = 'admin_supplier_details.tpl';
			elseif ($admin_page == 'DeliveryDetails')
				$this->mContentsCell = 'admin_delivery_details.tpl';
			elseif ($admin_page == 'Deliveries')
				$this->mContentsCell = 'admin_deliveries.tpl';
			elseif ($admin_page == 'OrderDetails')
				$this->mContentsCell = 'admin_supplier_details.tpl';
			elseif ($admin_page == 'StockControl')
				$this->mContentsCell = 'admin_stock_control.tpl';
			elseif ($admin_page == 'StockDetails')
				$this->mContentsCell = 'admin_stock_details.tpl';
			elseif ($admin_page == 'Shipping')
